...
KAFKA_GROUP = os.getenv("KAFKA_GROUP_ID", "notification-service")
...
def create_consumer():
    ...
    while True:
        ...
        try:
            ...
            print("✅ Notification Service Connected to Kafka", flush=True)
...
def start_consumer():
    ...
    print("📩 Notification Service Listening for transactions...", flush=True)
        ...
        for topic_partition, messages in records.items():
            ...
            for message in messages:
                ...
                try:
                    ...
                    print(
                        f"Notification → {user}: {tx_type} of ${amount}",
                        flush=True
                    )

                except Exception as err:

                    print("Error processing notification event:", err, flush=True)
